  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        onPressed: () {
          showModalBottomSheet(
            ...
            builder: (context) => Padding(
              padding: .symmetric(
                horizontal: Units.getHorizontalPadding(horizontalPadding: 15, context: context),
                vertical: Units.getVerticalPadding(verticalPadding: 10, context: context)
              ),
              child: Column(
              children: [
                Container(
      ...
      body: Padding(
        ...
        child: Column(children: [TaskItem()]),
      ),
    );
  }
}
